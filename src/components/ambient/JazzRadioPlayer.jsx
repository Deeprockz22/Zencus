...
export default function JazzRadioPlayer({ className = '', compact = false }) {
  ...
  return (
    <div className={`vintage-radio-tuner-card w-full max-w-xl mx-auto rounded-lg border-2 border-[#121212] bg-[var(--bg-secondary)] shadow-[6px_6px_0px_#121212] p-4 my-4 select-none ${className}`}>
          ...
          return (
            <button
              ...
              className={`flex flex-col text-left p-2 rounded border-2 transition-all active:translate-x-0.5 active:translate-y-0.5 ${
                isSelected
                  ? 'border-[#ff3b30] bg-[#ff3b30] bg-opacity-10 text-[var(--text-primary)] shadow-[2px_2px_0px_#ff3b30] dark:shadow-[2px_2px_0px_rgba(255,255,255,0.22)]'
                  : 'border-[#121212] dark:border-[rgba(255,255,255,0.3)] bg-[var(--bg-primary)] hover:bg-[var(--bg-tertiary)] text-[var(--text-secondary)] shadow-[2px_2px_0px_#121212] dark:shadow-[2px_2px_0px_rgba(255,255,255,0.2)]'
              }`}
            >
      ...
      <div className="flex items-center justify-between gap-3 pt-2 border-t-2 border-[#121212] dark:border-[rgba(255,255,255,0.35)]">
        <div className="flex items-center gap-2">
          {/* Main Tactile Play/Pause Button */}
          <button
            onClick={handleToggle}
            className={`flex items-center gap-2 px-4 py-2 rounded font-mono font-black text-xs uppercase tracking-wider text-white border-2 border-[#121212] dark:border-[rgba(255,255,255,0.4)] shadow-[3px_3px_0px_#121212] dark:shadow-[3px_3px_0px_rgba(255,255,255,0.28)] active:shadow-none active:translate-x-0.5 active:translate-y-0.5 transition-all ${
          ...
          <button
            onClick={handleNextStation}
            className="p-2 rounded border-2 border-[#121212] dark:border-[rgba(255,255,255,0.35)] bg-[var(--bg-primary)] hover:bg-[var(--bg-tertiary)] shadow-[2px_2px_0px_#121212] dark:shadow-[2px_2px_0px_rgba(255,255,255,0.22)] active:translate-x-0.5 active:translate-y-0.5 text-[var(--text-primary)] transition-all"
            title="Next Station"
          >
            <SkipForward size={14} />
          </button>
